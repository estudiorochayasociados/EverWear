                    ...
                    if (isset($_FILES['excel']['name']) && $_FILES['excel']['name'] != "") {
                        ...
                        if ($numCols == 15) {
                            for ($row = 2; $row <= $numRows; $row++) {
                                ...
                                $productos->set("cod_producto", $funciones->antihack_mysqli(isset($cod_producto) ? $cod_producto : ''));
                                ...
                                $checkProduct = $productos->list(["cod_producto='$cod_producto'", "variable7='1'"], '', '', false);
                                ...
                                $checkProduct = $productos->list(["cod_producto='$cod_producto'", "variable7='2'"], '', '1', false);
