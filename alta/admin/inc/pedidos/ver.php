...
if ($estado != '' && $cod != '') {
    ...
    $pedidos->changeState();
    $funciones->headerMove(URLADMIN . '/?op=pedidos&accion=ver');
}
...
<div class="mt-20">
    <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class='pull-right'>
                            <a href="<?= URLADMIN ?>/index.php?op=pedidos&accion=agregar" class="btn btn-success">AGREGAR PEDIDOS</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-5">
            <div class="col-md-3">
                <div class="j-order j-order-approved <?= $estadoFiltro ? $estadoFiltro == 2 ? '' : 'j-order-inactive' : '' ?>" onclick="document.location.href='<?= URLADMIN . "/index.php?op=pedidos&accion=ver&estadoFiltro=2" ?>'">
                    <div>
            ...
            <div class="col-md-3">
                <div class="j-order j-order-pending <?= $estadoFiltro ? $estadoFiltro == 1 ? '' : 'j-order-inactive' : '' ?>" onclick="document.location.href='<?= URLADMIN . "/index.php?op=pedidos&accion=ver&estadoFiltro=1" ?>'">
                    <div>
            ...
            <div class="col-md-3">
                <div class="j-order j-order-send <?= $estadoFiltro ? $estadoFiltro == 3 ? '' : 'j-order-inactive' : '' ?>" onclick="document.location.href='<?= URLADMIN . "/index.php?op=pedidos&accion=ver&estadoFiltro=3" ?>'">
                    <div>
            ...
            <div class="col-md-3">
                <div class="j-order j-order-failure <?= $estadoFiltro ? $estadoFiltro == 4 ? '' : 'j-order-inactive' : '' ?>" onclick="document.location.href='<?= URLADMIN . "/index.php?op=pedidos&accion=ver&estadoFiltro=4" ?>'">
                    <div>
...
if (!empty($_GET["borrar"])) {
    ...
    $pedidos->delete();
    $funciones->headerMove(URLADMIN . "/index.php?op=pedidos");
}
?>
