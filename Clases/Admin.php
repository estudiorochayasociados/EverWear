    ...
    public function listTable()
    {
        ...
        while ($row = mysqli_fetch_assoc($admin)) {
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Modificar"
                       href="<?= URL ?>/index.php?op=modificarPortfolio&id=<?= $row["id"] ?>">
                        <i class="fa fa-cog"></i>
                    </a>
                    <a class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Eliminar"
                       href="<?= URL ?>/index.php?op=verPortfolio&borrar=<?= $row["id"] ?>">
