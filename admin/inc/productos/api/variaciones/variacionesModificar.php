...
?>
    ...
    <div class="row">
        <form method="post" class="col-md-12" id="form-modal" action="<?= "https://" . $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"] ?>">
            ...
            <div class="col-md-12">
                Precio
                <input type="number" min="0" class="form-control" value="<?= isset($detalle['precio']) ? $detalle['precio'] : '' ?>" name="precio" required>
                Stock
                <input type="number" min="0" class="form-control" value="<?= isset($detalle['stock']) ? $detalle['stock'] : '' ?>" name="stock" required>
                Precio Mayorista
                <input type="number" min="0" class="form-control" value="<?= isset($detalle['precio_mayorista']) ? $detalle['precio_mayorista'] : '' ?>" name="precioMayorista">
            </div>
            <br>
            <div class="col-md-12">
