                ...
                ?>
                    <form method="post">
                        ...
                        ?>
                            ...
                            ?>
                                <label class=" mt-10 mb-10" style="font-size:16px">
                                    <input onclick="document.location.href='<?= URL . '/index.php?op=usuarios&accion=modificar&cod=' . $usuarioData['data']['cod'] . '&pedido=2'; ?>'" type="checkbox" name="factura" value="0"> Solicitar FACTURA A
                                </label>
                        <?php
                            }
                        }
