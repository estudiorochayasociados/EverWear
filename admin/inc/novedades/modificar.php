...
if (isset($_GET["ordenImg"]) && isset($_GET["idImg"])) {
    ...
    $imagenes->setOrder();
    $funciones->headerMove(URL_ADMIN . "/index.php?op=novedades&accion=modificar&cod=$cod");
}
            ...
            <div class="row">
                ...
                ?>
                        <div class='col-md-2 mb-20 mt-20'>
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <a href="<?= URL . '/index.php?op=novedades&accion=modificar&cod=' . $img['cod'] . '&borrarImg=' . $img['id'] ?>" class="btn btn-sm btn-block btn-danger">
                                        BORRAR IMAGEN
                                    </a>
                                </div>
