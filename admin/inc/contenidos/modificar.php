...
if (isset($_GET["ordenImg"]) && isset($_GET["idImg"])) {
    ...
    $imagenes->setOrder();
    $funciones->headerMove(URL_ADMIN . "/index.php?op=contenidos&accion=modificar&cod=$cod");
}
                ...
                if (!empty($data['images'])) {
                    foreach ($data['images'] as $img) {
                        ...
                        <div class='col-md-2 mb-20 mt-20'>
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <a href="<?= URL_ADMIN . '/index.php?op=contenidos&accion=modificar&cod=' . $data['data']['cod'] . '&borrarImg=' . $img['id'] ?>" class="btn btn-sm btn-block btn-danger">
                                        BORRAR IMAGEN
                                    </a>
                                </div>
