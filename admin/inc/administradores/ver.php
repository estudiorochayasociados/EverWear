...
<div class="mt-20">
    <div class="col-lg-12 col-md-12">
        <h4>Administradores
            <a class="btn btn-success pull-right" href="<?= URL_ADMIN ?>/index.php?op=administradores&accion=agregar">
                AGREGAR
                ADMINISTRADOR
            </a>
        </h4>
                ...
                ?>
                        <tr>
                            ...
                            <form method="post">
                                ...
                                <td>
                                    <a href="<?= URL . '/index.php?op=administradores&accion=modificar&id=' . $data['data']['id'] ?>"><i class="fa fa-cog"></i></a>
                                    <a href="<?= URL . '/index.php?op=administradores&accion=ver&borrar=' . $data['data']['id'] ?>"><i class="fa fa-trash"></i></a>
                                </td>
