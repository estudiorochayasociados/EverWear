...
<script>
    $(function() {
        $("#select-product").attr('data-id', '<?= $data["data"]["productos_cod"] ?>');
        $("#select-category").attr('data-id', '<?= $data["data"]["categorias_cod"] ?>');
        $("#select-subcategory").attr('data-id', '<?= $data["data"]["subcategorias_cod"] ?>');
