...
$template->set("title","Correas - Ever Wear");
                ...
                <div class="row">
                    <?php if (is_array($listAutomotor)) {
                        foreach ($listAutomotor as $correas) {
                            ...
                            $correas['data']['marca'] = str_replace("ë", "e", $correas["data"]["marca"]);
                            echo "<img src='" . URL . "/assets/img/sistema-correas/" . mb_strtolower(str_replace([" ", "/"], "-", trim($correas["data"]["marca"]))) . ".jpg' width='65' style='float:right !important' />";
                        ...
                        echo "<h1>No se encontraron correas con esas características</h1>";
                    }
                    ?>
                </div>
                <hr />
